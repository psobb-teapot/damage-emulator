...
const FIXTURES: Fixture[] = [
  ...
  {
    name: "P31: HUcast + Dark Flow (Hit0) 特殊5ヒット vs Claw — 最小ロール",
    cls: "HUcast", weaponKey: "Dark Flow", hitPercent: 0, attributePercent: 0,
    attacks: [{ type: "special", hits: 5 }],
    enemyKey: "Claw",
    ataInput: 241, minAtpInput: 756, maxAtpInput: 900,
    perAttack: [{ dmg: 557, acc: 32.69 }],
    total: 2785,
  },
  {
    name: "P32: HUcast + Dark Flow (Hit0) 特殊5ヒット vs Claw — 最大ロール",
    cls: "HUcast", weaponKey: "Dark Flow", hitPercent: 0, attributePercent: 0, maxRoll: true,
    attacks: [{ type: "special", hits: 5 }],
    enemyKey: "Claw",
    ataInput: 241, minAtpInput: 756, maxAtpInput: 900,
    perAttack: [{ dmg: 607, acc: 32.69 }],
    total: 3035,
  },
  {
